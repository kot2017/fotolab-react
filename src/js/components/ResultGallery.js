...
class ConnectedResultGallery extends Component {
    ...
    render() {
        ...
        // const path = dirname;
        //http://127.0.0.1:8082/foto/image?k=
      const katalog =  "FUJI_F400/100ASA/TetenalUltrafin/1do20/20min";
       ...
       const imageName = "N10142_Fuji400-100ASA_Tetenal-Ultrafin-1do20-20min_FOT12.jpg";
        //
      //  const imageURL = 'http://127.0.0.1:8082/foto/image?k=FUJI_F400/100ASA/TetenalUltrafin/1do20/20min/male/&f=N10142_Fuji400-100ASA_Tetenal-Ultrafin-1do20-20min_FOT17.jpg';
        //
        const img = [];
        ...
        //         img[i] = URL_IMAGE+  this.props.katalog + "/male/&f=" + images[i];
